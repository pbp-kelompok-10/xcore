...
urlpatterns = [
    ...
    path('update-vote/', update_vote, name='update_vote_ajax'),  # AJAX endpoint (tanpa vote_id di URL)
    path('my-votes/', my_votes, name='my_votes'),
    path('my-votes/update/<uuid:vote_id>/', update_vote, name='update_vote'),  # HTML form (dengan vote_id di URL)
