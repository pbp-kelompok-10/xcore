...
def highlight_detail(request, match_id):
    ...
    context = {
        'highlight': highlight,
        'home_team_flag': 'https://flagcdn.com/w80/'+match.home_team.country_code.lower()+'.png',
        'away_team_flag': 'https://flagcdn.com/w80/'+match.away_team.country_code.lower()+'.png',
    }
